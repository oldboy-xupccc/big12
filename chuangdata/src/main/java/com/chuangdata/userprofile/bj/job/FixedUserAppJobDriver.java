...
public class FixedUserAppJobDriver extends JobDriver {

    public FixedUserAppJobDriver(String[] args) {
        super(args);
    }
    ...
    protected int run(String[] args) throws IOException, ClassNotFoundException, InterruptedException, URISyntaxException {
        ...
        // 3. set Job
        Job job = Job.getInstance(getConfiguration(), FixedUserAppJobDriver.class.getSimpleName());
        job.setJarByClass(FixedUserAppJobDriver.class);
        job.setMapperClass(FixedUserAppMapper.class);
        job.setCombinerClass(UserAppCombiner.class);
        job.setReducerClass(FixedUserAppReducer.class);
    ...
    public static void main(String[] args) throws Exception {
        JobDriver jobDriver = new FixedUserAppJobDriver(args);
