 ...
 * 
 */
public class ExtractReducer extends Reducer<Text, MultipleModel, NullWritable,Writable > {
	private static final Logger LOG = Logger.getLogger(ExtractReducer.class);
...
//								+ "/part");
		...
		outKey.set(key.toString());
			...
			for (String userAgentId : userAgentMap.keySet()) {
				...
				multipleOutputs.write(nw, row, userAgentMap.get(userAgentId).getName() + hivePath
						+ "/part");
...
//					+ "/part");
           ...
           //2016-10-10 Changed by luxiaofeng: write with orc file type
			...
			multipleOutputs.write(nw, row, appDomainMap.get(appDomainId).getName() + hivePath
					+ "/part");
...
//					+ "/part");
			...
			multipleOutputs.write(nw, row, appMap.get(appId).getName() + hivePath
					+ "/part");
...
//					.getName() + "/part");
			...
			multipleOutputs.write(nw, row, actiomMap.get(behaviourId).getName() + hivePath
					+ "/part");
...
//						+ "/part");
				...
				multipleOutputs.write(nw, row, param.getName() + hivePath
						+ "/part");
