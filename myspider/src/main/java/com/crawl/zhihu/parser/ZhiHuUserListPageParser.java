...
public class ZhiHuUserListPageParser implements ListPageParser{
    ...
    public List<ZhihuUserInfo> parseListPage(Page page) {
        List<ZhihuUserInfo> zhihuUserInfoList = new ArrayList<ZhihuUserInfo>();
        ...
        for (int i = 0; i < userCount; i++){
            ...
            zhihuUserInfoList.add(zhihuUserInfo);
        }
        return zhihuUserInfoList;
    }
    /**
